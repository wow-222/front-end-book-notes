(function () {
  ...
  function () {
    ...
    _createClass(ShoppingCart, [{
      ...
      value: function initBtn() {
        ...
        var $btn = jquery('<button>购物车</button>');
        $btn.click(function () {
          _this.showCart();
        });
        this.$el.append($btn);
  ...
  var StateMachine = unwrapExports(stateMachine);
  ...
  function () {
    ...
    _createClass(Item, [{
      ...
      value: function initContent() {
        var $el = this.$el;
        var data = this.data;
        $el.append(jquery("<p>\u540D\u79F0\uFF1A".concat(data.name, "</p>")));
        $el.append(jquery("<p>\u4EF7\u683C\uFF1A".concat(data.price, "</p>")));
      }
    }, {
      key: "initBtn",
      value: function initBtn() {
      ...
      key: "deleteFromCartHandel",
      value: function deleteFromCartHandel() {
  ...
  function () {
    ...
    _createClass(List, [{
      ...
      value: function loadData() {
        return fetch('./test.json').then(function (result) {
          return result.json();
        });
      } // 生成列表
      ...
      value: function initItemList(data) {
        ...
        data.forEach(function (itemData) {
          // 创建一个Item 然后 init
          var item = createItem(_this, itemData);
          item.init();
        });
      }
    }, {
  ...
  function () {
    ...
    _createClass(App, [{
      ...
      value: function initShoppingCart() {
        var shoppingCart = new ShoppingCart(this);
        shoppingCart.init();
      } // 初始化列表
